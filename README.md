...
├── 64bit.srcs/
│   ├── sources_1/new/               # CPU core, ALU, FPU, register file, etc. (.v)
│   ├── sources_1/ip/                 # Generated IP cores (.xci) + my_program.coe
│   ├── sources_1/bd/design_1/        # Block design (currently disabled)
│   ├── constrs_1/new/pins.xdc        # Pin constraints for the Basys3
│   └── sim_1/new/tb_soc.v            # Testbench
└── README.md
```
